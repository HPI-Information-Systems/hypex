...
class ParameterDistribution:
    ...
    def random_guess(self, generator: "hypaad.ValueGenerator") -> t.Any:
        kwargs = {
            "dtype": self.dtype,
        }
        if self.min_value is not None:
...
class MultidimensionalParameterDistribution:
    parameter_distributions: t.List["hypaad.ParameterDistribution"]
    ...
    def random_guess(self, generator: "hypaad.ValueGenerator") -> t.Dict[str, t.Any]:
        return {
    ...
    def from_config(
        ...
        return cls(
            parameter_distributions=[
                hypaad.ParameterDistribution.from_config(config=param_dist)
