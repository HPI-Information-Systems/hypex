...
class ParameterModel:
    ...
    def __init__(
        ...
        param_models: t.Dict[str, "hypex.NonLinearRegressionFrozenModel"],
    ...
    def create_from(
        ...
        edge_data: t.Dict[t.Tuple[int, int], "hypex.RegressionResult"],
        ...
        if not nx.is_directed_acyclic_graph(graph):
            pruned_graph, removed_edges = hypex.dfs_remove_back_edges(graph)
        ...
        for node in algorithm_params:
            ...
            if len(nodes_pre) == 0:
                ...
                parameter_distribution: hypex.ParameterDistribution = [
                    dist
