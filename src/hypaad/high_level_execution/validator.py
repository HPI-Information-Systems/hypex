...
class Validator(BaseRunner):
    ...
    class Intermediate:
        ...
        csl_result: "hypaad.NonLinearPC.Result"
    ...
    def _map_parameters(
        self,
        _input: t.List[t.Tuple[str, "hypaad.NonLinearPC.Result"]],
        study: "hypaad.Study",
        ...
        registry = hypaad.Registry.default()
    ...
    def _run_algorithm(
        ...
        _input: t.List[
            t.Tuple[
                str,
                "hypaad.NonLinearPC.Result",
                t.Dict[str, t.Any],
                int,
            ]
        ],
        study: "hypaad.Study",
        result_data_generation: "hypaad.DataGenerationModule.Result",
    ) -> t.List[t.Tuple[float, float, "hypaad.TrialResult", "hypaad.NonLinearPC.Result"]]:
        if len(_input) != 1:
        ...
        trial_result = hypaad.Optimizer.run_and_score_algorithm(
            trial_id=idx,
    ...
    def _to_intermediate(
        self,
        _input: t.List[t.Tuple["hypaad.TrialResult", "hypaad.NonLinearPC.Result"]],
    ...
    def determine_fixed_parameters(
        self,
        study: "hypaad.Study",
        result_train: "hypaad.CSLModule.Result",
        ...
        _distribution = hypaad.EvaluationModule.get_parameter_distribution_from_training(
            study=study,
        ...
        trial_results = (
            hypaad.EvaluationModule(seed=self.seed)
            .run(
