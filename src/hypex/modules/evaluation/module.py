...
class EvaluationModule(BaseModule):
    ...
    def run_with_default_parameters(
        ...
        return [
            dask.delayed(hypex.Optimizer.run_and_score_algorithm)(
                trial_id=1,
    ...
    def run_with_parameter_model(
        ...
        parameter_model: t.Optional["hypex.ParameterModel"] = None,
        registry=Registry.default(),
    ) -> t.List["hypex.TrialResult"]:
        results = []
        for timeseries_name in timeseries_names:
    ...
    def get_parameter_distribution_from_training(
        cls, study: hypex.Study, csl_data: pd.DataFrame
    ):
        ...
        return hypex.MultidimensionalParameterDistribution(
    ...
    def run(
        ...
        parameter_model: t.Optional["hypex.ParameterModel"] = None,
    ) -> "hypex.OptimizationModule.Result":
        @dask.delayed
        def create_postprocess_parameter_guess_func(
            parameter_model: hypex.ParameterModel,
        ):
