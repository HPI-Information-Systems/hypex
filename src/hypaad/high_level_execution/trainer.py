...
class Trainer(BaseRunner):
    ...
    def prepare_partial(
        ...
        "hypaad.OptimizationModule",
        t.List["hypaad.OptimizationModule.Intermediate"],
    ]:
        optimization_module = hypaad.OptimizationModule(
    ...
    def run_partial(
        self,
        optimization_module: "hypaad.OptimizationModule",
        input_data: t.List["hypaad.OptimizationModule.Intermediate"],
        n_trials: int,
    ...
    def run(
        ...
        study: hypaad.Study,
        score_variable: str,
    ) -> t.Dict[str, "hypaad.CSLModule.Result"]:
        ...
        optimiztion_result = hypaad.OptimizationModule(
            storage=self.storage,
            study_name=study.name,
            timeseries_names=timeseries_names,
            data_paths=result_data_generation.data_paths,
